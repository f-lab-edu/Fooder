...
(
    ...
    `SALE_POSSIBLE_QUANTITY` INT          NOT NULL,
    `PRICE`                  INT          NOT NULL
);
...
(
    `OPTION_GROUP_SPEC_ID` INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
...
(
    `OPTION_SPEC_ID`       INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
...
(
    `ORDER_OPTION_GROUP_ID`   INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
