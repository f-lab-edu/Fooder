...
(
    `OPTION_GROUP_SPEC_ID` INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
(
    `OPTION_SPEC_ID`       INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
(
    `ORDER_OPTION_GROUP_ID`   INT AUTO_INCREMENT NOT NULL,
    `ORDER_ITEM_ID`           INT          NOT NULL,
    `ORDER_OPTION_GROUP_NAME` VARCHAR(100) NOT NULL,
    PRIMARY KEY (ORDER_OPTION_GROUP_ID, ORDER_ITEM_ID, ORDER_OPTION_GROUP_NAME)
);

DROP TABLE IF EXISTS ORDER_OPTION;
CREATE TABLE `ORDER_OPTION`
(
    `ORDER_OPTION_ID`       INT AUTO_INCREMENT NOT NULL,
    `ORDER_OPTION_GROUP_ID` INT          NOT NULL,
    `ORDER_OPTION_NAME`     VARCHAR(100) NOT NULL,
    `ORDER_OPTION_PRICE`    INT          NOT NULL,
    PRIMARY KEY (ORDER_OPTION_ID, ORDER_OPTION_GROUP_ID, ORDER_OPTION_NAME, ORDER_OPTION_PRICE)
);
